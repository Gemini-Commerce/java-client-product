...
public class EntitymanagerBulkCreateAttributeRequest {
   ...
   * @return the EntitymanagerBulkCreateAttributeRequest instance itself
   */
  public EntitymanagerBulkCreateAttributeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, entitymanagerBulkCreateAttributeRequest.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, entitymanagerBulkCreateAttributeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, entityData, entityId, attributes, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EntitymanagerBulkCreateAttributeRequest>() {
           ...
           public EntitymanagerBulkCreateAttributeRequest read(JsonReader in) throws IOException {
             ...
             EntitymanagerBulkCreateAttributeRequest instance = thisAdapter.fromJsonTree(jsonObj);
