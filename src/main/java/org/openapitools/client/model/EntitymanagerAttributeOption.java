...
public class EntitymanagerAttributeOption {
  ...
  private List<EntitymanagerAttributeOptionSwatch> swatches = new ArrayList<>();
   ...
   * @return the EntitymanagerAttributeOption instance itself
   */
  public EntitymanagerAttributeOption putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.option, entitymanagerAttributeOption.option) &&
        ...
        Objects.equals(this.additionalProperties, entitymanagerAttributeOption.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(option, sort, id, code, value, swatches, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EntitymanagerAttributeOption>() {
           ...
           public EntitymanagerAttributeOption read(JsonReader in) throws IOException {
             ...
             EntitymanagerAttributeOption instance = thisAdapter.fromJsonTree(jsonObj);
