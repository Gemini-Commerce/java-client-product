...
public class ProductAssetData {
   ...
   * @return the ProductAssetData instance itself
   */
  public ProductAssetData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assetGrn, productAssetData.assetGrn) &&
        ...
        Objects.equals(this.additionalProperties, productAssetData.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductAssetData>() {
           ...
           public ProductAssetData read(JsonReader in) throws IOException {
             ...
             ProductAssetData instance = thisAdapter.fromJsonTree(jsonObj);
